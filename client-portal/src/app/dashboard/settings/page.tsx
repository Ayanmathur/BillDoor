        ...
        <div className="settings-section">
          ...
          <div style={{ marginTop: 'var(--space-4)', paddingTop: 'var(--space-4)', borderTop: '1px solid var(--color-border-subtle)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
              {logoUrl ? (
                <div style={{ maxWidth: 160, maxHeight: 64, minWidth: 64, padding: '4px var(--space-2)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', overflow: 'hidden', background: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <img src={logoUrl} alt="Logo" style={{ maxWidth: '100%', maxHeight: 56, width: 'auto', height: 'auto', objectFit: 'contain', background: '#ffffff' }} />
                </div>
              ) : (
